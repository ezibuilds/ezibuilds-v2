...
export function Expertise() {
  const cols = Object.entries(expertise);
  return (
    <section id="expertise" className="bg-cream py-24 sm:py-32">
            ...
            >
              ...
              <ul className="space-y-3">
                {items.map((item) => (
                  <li
                    key={item}
                    className="text-[clamp(1.05rem,1.6vw,1.4rem)] font-medium tracking-tight"
                  >
                    {item}
                  </li>
                ))}
